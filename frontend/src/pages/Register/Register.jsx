...
const Register = () => {
  ...
  return (
    <section className="min-vh-100 d-flex justify-content-center gradient-custom-3 register">
      <div className="container">
        <div
          className="card shadow my-signup-card-style"
          style={{ borderRadius: 20 }}
        >
          <div className="column-1">
            <img src="/Frame4.svg" alt="signup page image" />
          </div>

          <div className="card-body p-5 column-2">
